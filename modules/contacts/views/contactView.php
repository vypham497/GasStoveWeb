        ...
        <div class="section" id="order-review-wp">
            ...
            <div class="section-detail">
                <table class="shop-table">
                    <thead>
                        <tr>
                            <td>Bep Viet Store</td>
                        </tr>
                    </thead>
                    <tbody>
                        <tr class="cart-item">
                            <td class="product-name">Address: 015 Lô 1 cư xá Thanh Đa, P.27, Q. Bình Thạnh, TP.HCM<strong class="product-quantity"></strong></td>
                        </tr>
                        <tr class="cart-item">
                            <td class="product-name">Mobile: 0964101044 <strong class="product-quantity"></strong></td>
                        </tr>
                        <tr class="cart-item">
                            <td class="product-name">Fax: 1-714-252-0026<strong class="product-quantity"></strong></td>
                        </tr>
                        <tr class="order-total">
                            <td><strong class="total-price">Email: bepvietstore@gmail.com</strong></td>
                        </tr>
                    </tbody>
                    <tfoot>
                        <tr class="order-total">
