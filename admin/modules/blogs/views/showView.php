                    ...
                    <form method="POST" action="?modules=blogs&controllers=index&action=update&id=<?php echo $value['id'] ;?>" enctype="multipart/form-data">
                        <div style="display: flex;">
                            <div style="width: 400px;">
                                ...
                                <input type="text" name="id" id="title" value="<?php echo $value['id']; ?>" style="display: block;width: 300px;">
                        ...
                        <label for="cont">Chủ đề</label>
                        <textarea name="content" id="cont" class="ckeditor"><?php echo $value['content']; ?></textarea>
